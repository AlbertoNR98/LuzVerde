...
public class valorSensorContaminacion {
	...
	public valorSensorContaminacion(int idValorSensor, int sensorID, float value, float accuracy, long timeStamp) {
		super();
	...
	public String toString() {
		return "valorSensorContaminacion [idValorSensor=" + idValorSensor + ", sensorID=" + sensorID + ", value="
				+ value + ", accuracy=" + accuracy + ", timeStamp=" + timeStamp + "]";
	}
